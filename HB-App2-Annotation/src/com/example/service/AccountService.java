...
public class AccountService {
	...
	public static void main(String[] args) {
		...
		createAccount.setAccNo(5);
		createAccount.setName("Bhushan");
		createAccount.setBalance(55000);
		createAccount.setAccCreationDate(new Date());
		dao.insertAccountDetails(createAccount);

		createAccount.setAccNo(6);
		createAccount.setName("Hitesh");
		createAccount.setBalance(400000);
		createAccount.setAccCreationDate(new Date());
		dao.insertAccountDetails(createAccount);
