...
public class AccountService {
	...
	public static void main(String[] args) {
		...
		try {
			...
			AccountBean accountBeanLoad = (AccountBean)session.get(AccountBean.class, 5L);
			...
			System.out.println("Account Details .. : ");
			System.out.println("Account No .. : " + accountBeanLoad.getAccNo());
			System.out.println("Account Holder Name .. : " + accountBeanLoad.getName());
			System.out.println("Account Balnce .. : " + accountBeanLoad.getBalance());
			System.out.println("Account Creation Date .. : " + accountBeanLoad.getAccCreationDate());
